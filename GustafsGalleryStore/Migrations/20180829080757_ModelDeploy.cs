...
{
    public partial class ModelDeploy : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("insert into AspNetRoles (id,name,normalizedname,concurrencystamp) values('9710793b-4866-45b7-8fc2-c024f91fdee8','IsStaff','ISSTAFF',getdate())");
            ...
            migrationBuilder.Sql("insert into aspNetUserRoles(UserId,RoleId) values('318e08a0-59eb-4a1a-8a66-28b2137556df','9710793b-4866-45b7-8fc2-c024f91fdee8')");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryCompanyId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageReference = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
